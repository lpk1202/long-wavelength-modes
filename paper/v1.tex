...
\ee
Notice \ec{pert1}, \ec{pert2} and \ec{f2} are completely accurate only in Einstein-de Sitter universe. Nonetheless when we actually do related calculation in $\Lambda$CDM universe, the difference is negligible \cite{Takahashi:2008to} thus we still use the expression from \ec{pert1} and \ec{f2} throughout the whole work.\\
