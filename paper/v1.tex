...
\newcommand{\sfigg}[2]{
\includegraphics[width=0.9\paperwidth]{../plots/#1}
        }
\newcommand{\sfigr}[2]{
...
In this section we review the SPT approach which describes small scale nonlinearity. Then we compute the off-diagonal term of two short-wavelength modes in the squeezed limit. This off-diagonal term proportional to \peikai{with or without an "a"?}long-wavelength mode will be the key factor of constructing the quadratic estimator. \\
