...
\ee 
Plugging the perturbative series \ec{pert1} and \ec{pert2} into the Fourier transformed fluid equations \ec{fluid1}-\ec{fluid3}, we can solve second-order density contrast and the result is given by:
\be
